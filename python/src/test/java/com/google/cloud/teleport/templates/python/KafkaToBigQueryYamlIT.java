    ...
    PipelineLauncher.LaunchConfig.Builder options =
        paramsAdder.apply(
            PipelineLauncher.LaunchConfig.builder(testName, specPath)
                .addParameter("sdk_location", "container")
                .addParameter(
                    "sdk_harness_container_image_overrides",
                    ".*python.*,us-central1-docker.pkg.dev/cloud-teleport-testing/jkinard-test/dataflow/beam_python3.11_sdk:2.53.0")
                .addEnvironment(
                    "additionalExperiments",
                    Collections.singletonList("disable_worker_rolling_upgrade"))
                .addParameter(
