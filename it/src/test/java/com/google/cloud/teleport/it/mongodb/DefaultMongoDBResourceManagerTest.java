...
public class DefaultMongoDBResourceManagerTest {
  ...
  public void testInsertDocumentsShouldCreateCollectionIfOneDoesNotExist() {
    ...
    assertThat(testManager.insertDocuments(COLLECTION_NAME, ImmutableList.of(new Document())))
        .isEqualTo(true);
  ...
  public void
    ...
    assertThat(tm.insertDocuments(COLLECTION_NAME, ImmutableList.of(new Document())))
        .isEqualTo(true);
  ...
  public void testInsertDocumentsShouldThrowErrorWhenMongoDBThrowsException() {
    ...
    assertThrows(
        ...
        () -> testManager.insertDocuments(COLLECTION_NAME, ImmutableList.of(new Document())));
  }
