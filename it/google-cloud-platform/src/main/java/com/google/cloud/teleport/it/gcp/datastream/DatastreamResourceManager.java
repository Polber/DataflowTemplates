...
import static com.google.cloud.teleport.it.gcp.datastream.DatastreamResourceManagerUtils.generateDatastreamId;
...
public final class DatastreamResourceManager implements ResourceManager {
    ...
    switch (source.type()) {
      ...
      case ORACLE:
        ...
        oracleProfileBuilder
            ...
            .setPassword(source.password())
            .setPort(source.port())
            .setDatabaseService(((OracleSource) source).databaseService());
   ...
   * @param gcsRootPath The Path prefix to specific gcs location. Must be empty or specify a GCS
   *     path.
