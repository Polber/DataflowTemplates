...
import com.google.cloud.teleport.it.common.testcontainers.TestContainerResourceManagerException;
 ...
 *
 * <p>Note: The Splunk TestContainer will only run on M1 Mac's if the Docker version is
 * >= 4.16.0 and the "Use Rosetta for x86/amd64 emulation on Apple Silicon" setting is
 * enabled.
 */
