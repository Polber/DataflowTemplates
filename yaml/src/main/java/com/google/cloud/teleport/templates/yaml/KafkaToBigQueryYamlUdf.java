...
@Template(
    name = "Kafka_to_BigQuery_Yaml_Udf",
    ...
    flexContainerName = "kafka-to-bigquery-yaml-jkinard-udf",
    yamlTemplateName = "KafkaToBigQueryUdf.yaml",
    documentation =
    ...
    streaming = true,
    hidden = true)
public interface KafkaToBigQueryYamlUdf {
