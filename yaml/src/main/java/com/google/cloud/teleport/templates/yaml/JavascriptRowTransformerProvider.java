...
import static com.google.cloud.teleport.v2.transforms.JavascriptTextTransformer.getJavascriptRuntime;
...
public class JavascriptRowTransformerProvider
  ...
  protected static class JavascriptRowTransform extends SchemaTransform {
    ...
    private Counter successCounter =
        Metrics.counter(JavascriptRowTransform.class, "udf-transform-success-count");

    private Counter failedCounter =
        Metrics.counter(JavascriptRowTransform.class, "udf-transform-failed-count");

    public JavascriptRowTransform(Configuration configuration) {
