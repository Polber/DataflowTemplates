...
//
//@Template(
//    name = "Kafka_to_BigQuery_Yaml_Udf2",
//    category = TemplateCategory.STREAMING,
//    type = Template.TemplateType.YAML,
//    displayName = "Kafka to BigQuery UDF (YAML)",
//    description =
...
//    flexContainerName = "kafka-to-bigquery-yaml-udf",
...
//      name = "schemaPath",
//      optional = true,
//      description = "Cloud Storage path to the schema file",
//      helpText = "Cloud Storage path to schema file. For example, gs://MyBucket/file.avsc.")
