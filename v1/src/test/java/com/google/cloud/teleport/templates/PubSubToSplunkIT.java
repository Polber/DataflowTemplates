...
public class PubSubToSplunkIT extends TemplateTestBase {
  ...
  private static final int MESSAGES_COUNT = 40;
  private static final int BAD_MESSAGES_COUNT = 10;

  private PubsubResourceManager pubsubResourceManager;
  private SplunkResourceManager splunkResourceManager;

  private static TopicName pubSubTopic;
  private static TopicName pubSubDlqTopic;
  private static SubscriptionName pubSubSubscription;
  private static SubscriptionName pubSubDlqSubscription;
  ...
  public void setUp() throws IOException {
    pubsubResourceManager =
        DefaultPubsubResourceManager.builder(testName, PROJECT)
            ...
            .build();
    splunkResourceManager = DefaultSplunkResourceManager.builder(testName).build();
  ...
  private void testPubSubToSplunkMain(
    ...
    for (int i = 1; i <= MESSAGES_COUNT; i++) {
      ...
      String pubSubMessage = new JSONObject(Map.of("_metadata", splunkEventToMap(splunkEventBeforeUdf))).toString();
